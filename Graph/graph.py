# A undirected graph means that the relationship along an edge between two nodes is 
# bidirectional, it can go either way.
# if the graphs is sparse, that is if most of the possible edges are not present, 
# then the adjacency-list representation can save space.
